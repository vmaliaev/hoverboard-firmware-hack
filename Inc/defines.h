...
#define LEFT_TIM_U CCR2
#define LEFT_TIM_UH_PIN GPIO_PIN_7
#define LEFT_TIM_UH_PORT GPIOC
#define LEFT_TIM_UL_PIN GPIO_PIN_0
#define LEFT_TIM_UL_PORT GPIOB
#define LEFT_TIM_V CCR3
...
#define LEFT_TIM_W CCR1
#define LEFT_TIM_WH_PIN GPIO_PIN_6
#define LEFT_TIM_WH_PORT GPIOC
#define LEFT_TIM_WL_PIN GPIO_PIN_7
#define LEFT_TIM_WL_PORT GPIOA



//Right motor
#define RIGHT_TIM TIM1
#define RIGHT_TIM_U CCR2
#define RIGHT_TIM_UH_PIN GPIO_PIN_9
#define RIGHT_TIM_UH_PORT GPIOA
#define RIGHT_TIM_UL_PIN GPIO_PIN_14
#define RIGHT_TIM_UL_PORT GPIOB
#define RIGHT_TIM_V CCR3
#define RIGHT_TIM_VH_PIN GPIO_PIN_10
#define RIGHT_TIM_VH_PORT GPIOA
#define RIGHT_TIM_VL_PIN GPIO_PIN_15
#define RIGHT_TIM_VL_PORT GPIOB
#define RIGHT_TIM_W CCR1
#define RIGHT_TIM_WH_PIN GPIO_PIN_8
#define RIGHT_TIM_WH_PORT GPIOA
#define RIGHT_TIM_WL_PIN GPIO_PIN_13
